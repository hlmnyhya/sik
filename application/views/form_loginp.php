    ...
    <div class="container">
      <div class="form-outer text-center d-flex align-items-center">
        <div class="form-inner">
          ...
          <p></p>
          <?php echo form_open('loginp/if', 'class="text-left form-validate"'); ?>
          ...
          <div class="form-group text-center"><button class="btn btn-success mb-3">Login Penduduk</button>

            <a href="<?php echo site_url('penduduk') ?>" class="btn btn-danger mb-3">Daftar Penduduk</a>

            <a href="<?php echo site_url('login') ?>" class="btn btn-warning">Login Administrator</a>
